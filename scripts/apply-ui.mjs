...
for (const ext of ["lakshx-ui", "lakshx-chat", "lakshx-graph", "lakshx-db", "lakshx-commentary", "lakshx-welcome", "lakshx-commandbar", "lakshx-extensions", "lakshx-search", "lakshx-structural-search", "lakshx-tab", "lakshx-terminal", "lakshx-testing", "theme-lakshx-carbon", "theme-lakshx-symbols"]) {
